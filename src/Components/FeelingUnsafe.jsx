    ...
    <div>
      <header className="FeelingUnsafe-section">
        <div className="FeelingUnsafe-left">
          ...
          <p>
            Feeling unsafe at home? Does life feel heavy? Do you need an out or safe place? Use Friend to learn about waht abuse is, get free resources, and connect with your school counselor to get help!
          </p>
        </div>
